...
def readImage(img_name, url):
    ...
    cv2.imwrite(os.path.join('./public/images/',"image44.jpg"), img)
...
def changeColor(image_name, position, new_color, pattern_image, url):
    start = datetime.timestamp(datetime.now())
    img = readImage(image_name, url)
...
changeColor('image44.jpg', (300, 100),[135, 168, 161], None, url)
